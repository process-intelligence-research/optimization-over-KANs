...
- _function___H_X__N_X__G_X for all models used to study the effect of grid-size on optimization effort
- _function___H_X__N_X for all models used to study the effect of number of neurons in one hidden layer on optimization effort
